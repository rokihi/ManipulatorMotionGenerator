// -*- C++ -*-
/*!
 * @file  ManipulatorMotionGeneratorRTC.h
  ...
  : public RTC::DataFlowComponentBase
{
 public:
   ...
   */
  ManipulatorMotionGeneratorRTC(RTC::Manager* manager);
...
extern "C"
{
  DLL_EXPORT void ManipulatorMotionGeneratorRTCInit(RTC::Manager* manager);
};

#endif // MANIPULATORMOTIONGENERATORRTC_H
